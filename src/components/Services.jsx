      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center bg-purple-100 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-purple-800 font-medium">Premium Pet Boarding</span>
          </div>
            ...
            >
              ...
              <div className="relative p-8">
                <div className="flex items-center mb-6">
                  <div className={`bg-gradient-to-br ${service.gradient} p-4 rounded-2xl text-white shadow-lg`}>
                    {service.icon}
                  </div>
                  <div className="ml-4">
                ...
                <a
                  ...
                  className={`w-full bg-gradient-to-r ${service.gradient} text-white py-4 px-6 rounded-2xl font-semibold hover:shadow-lg transition-all duration-300 text-center block transform hover:scale-105`}
                >
                  Book This Service
                </a>
              </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="text-center group">
              <div className="bg-white w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110">
                {React.cloneElement(feature.icon, { className: `h-8 w-8 ${feature.color}` })}
              </div>
